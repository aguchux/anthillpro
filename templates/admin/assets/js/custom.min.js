var Tixia = function() {
    var e = $(window).width(),
        ...
        a = function() {
            var t = jQuery("body").data("layout");
            jQuery(".schedule-event-inner").length > 0 && jQuery(".schedule-event-inner").unbind().on("click", function() {
                jQuery(".event-sidebar").toggleClass("active")
            }), ("horizontal" == t || jQuery(".schedule-event").length > 0 && 1400 > e) && jQuery(".schedule-event").on("click", function() {
                jQuery(".event-sidebar").toggleClass("active")
            })
        },
        o = function() {
    ...
    return {
        init: function() {
            ...
            t(), n(), jQuery("#menu").length > 0 && $("#menu").metisMenu(), jQuery(".metismenu > .mm-active ").each(function() {
                ...
                }), c = window.outerHeight, ((c = window.outerHeight) > 0 ? c : screen.height) && $(".content-body").css("min-height", c + 60 + "px"), $('a[data-action="collapse"]').on("click", function(e) {
                ...
                function() {
                    ...
                    thumbnail: !0
                }), a(), jQuery("#datetimepicker1").length > 0 && $("#datetimepicker1").datetimepicker({
                    inline: !0
                }),
                function() {
                ...
                }(), o(), jQuery("#smartwizard").length > 0 && $("#smartwizard").smartWizard()
        },
        load: function() {
            t(), n()
        },
